-- ============================================================================
-- Migration: 009_seed_test_data.sql
-- Purpose: Populate database with realistic test data for development/QA
-- Author: Compliance Team
-- Created: 2026-03-04
--
-- NOTE: This migration is OPTIONAL and should only be applied in development/QA
--       environments. Do NOT apply in production.
--
-- Data Includes:
--   - UUID (AE): Clean individual, pending company, sanctions-flagged individual
...
--   - Compliance aggregates and audit trail entries
-- ============================================================================
...
INSERT INTO audit_logs (entity_id, action, entity_type, changes)
VALUES 
    ('ae-ind-clean-001', 'KYC_APPROVED', 'individual', '{"reason": "All documents verified and clean", "system": "auto"}'),
    ('ae-ind-clean-001', 'AML_APPROVED', 'individual', '{"reason": "Chainalysis screening clear", "system": "auto"}'),
    ('in-corp-pep-002', 'PEP_FLAGGED', 'company', '{"reason": "Beneficial owner identified in PEP database", "team": "aml_team"}'),
    ('in-corp-pep-002', 'ESCALATED_FOR_REVIEW', 'company', '{"reason": "Enhanced due diligence team assigned", "team": "compliance_officer"}'),
    ('us-corp-accredited-001', 'KYC_APPROVED', 'company', '{"reason": "SEC accreditation verified", "system": "auto"}'),
    ('us-fund-pending-003', 'SUBMISSION_RECEIVED', 'fund', '{"reason": "Form ADV and legal docs pending", "system": "api_gateway"}')
ON CONFLICT DO NOTHING;
